...
Label(root, text='Youtube Video Downloader', font='arial 15 bold').pack() # Title of the program

link = StringVar() # Variable for save link of video

Label(root, text='Paste Link Here:', font='arial 13 bold').place(x=160, y=60)
